...
Site desenvolvido para praticar a utilização de CSS3.(Meu primeiro site desvolvido utilizando CSS3).
...
-Aplicar os conhecimentos sobre CSS3;
...
## :pager: Tela principal da Site Anna Bella

 <img src="https://github.com/cleuber-andrade/Projeto_Anna_Bella/blob/main/img/annabela.jpg" alt="Tela Principal">

## :globe_with_meridians: Link para acessar site no GitHubPages

Para visualizar o site no GitHubPages <a href="https://cleuber-andrade.github.io/Projeto_Anna_Bella/" target="_blank">Clique aqui</a>

## 👷 Como rodar

```bash
# Clonar o repositório
git clone https://github.com/cleuber-andrade/Projeto_Anna_Bella.git
